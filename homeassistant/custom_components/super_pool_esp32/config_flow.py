"""Config flow for Super Pool ESP32 (direct ESP32 mode)."""
...
class SuperPoolESP32ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def __init__(self) -> None:
        ...
        self._discovered_name: str = "Super Pool ESP32"
    ...
    async def async_step_zeroconf(
        ...
        """ESP advertised _superpoolapi._tcp — confirm before adding."""
        ...
        self._discovered_name = raw.split("._")[0].strip() or "Super Pool ESP32"
    ...
    ) -> SuperPoolESP32OptionsFlow:
        return SuperPoolESP32OptionsFlow(config_entry)
    ...
    async def _probe_esp(self, url: str, api_key: str) -> tuple[str, str]:
        ...
        name    = self._discovered_name if ctrl_id == self._controller_id else f"Super Pool {ctrl_id}"
        return ctrl_id, name


class SuperPoolESP32OptionsFlow(config_entries.OptionsFlow):
